      ...
      <div className=" p-10 md:p-4 md:px-20">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger>What are the sources of carbon emissions?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>How can we offset carbon emissions?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>What Causes The Most Carbon Emissions? </AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger>What does carbon emissions affect the most?</AccordionTrigger>
            <AccordionContent>
